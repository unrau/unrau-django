...
# load images
background = simplegui.load_image('http://dax.rip/static/files/pong/bg-c.jpg')
p1scored = simplegui.load_image('http://dax.rip/static/files/pong/p1-scored.jpg')
p2scored = simplegui.load_image('http://dax.rip/static/files/pong/p2-scored.jpg')
aiscored = simplegui.load_image('http://dax.rip/static/files/pong/ai-scored.jpg')
...
sound_gutter = simplegui.load_sound('http://dax.rip/static/files/pong/gutter.ogg')
sound_bounce = simplegui.load_sound('http://dax.rip/static/files/pong/bounce.ogg')
sound_score = simplegui.load_sound('http://dax.rip/static/files/pong/score.ogg')
sound_fail = simplegui.load_sound('http://dax.rip/static/files/pong/failure.ogg')
sound_countdown = simplegui.load_sound('http://dax.rip/static/files/pong/countdown.ogg')
sound_launch = simplegui.load_sound('http://dax.rip/static/files/pong/launch.ogg')
sound_newgame = simplegui.load_sound('http://dax.rip/static/files/pong/reset.ogg')
sound_shrink = simplegui.load_sound('http://dax.rip/static/files/pong/shrink.ogg')
sound_grow = simplegui.load_sound('http://dax.rip/static/files/pong/grow.ogg')
