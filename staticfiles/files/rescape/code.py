...
# are copyright 2013 Tristen Unrau (http://unrau.me)

splash_info = ImageInfo([800, 600])
splash_image_blank = simplegui.load_image("")
splash_image_game_over = simplegui.load_image(
    "http://dax.rip/static/files/rescape/images/game-over.png")
splash_image_level_status = simplegui.load_image(
    "http://dax.rip/static/files/rescape/images/level-status.png")
splash_image_beat_game = simplegui.load_image(
    "http://dax.rip/static/files/rescape/images/beat-game.png")
splash_image = splash_image_blank

story_info = ImageInfo([800, 600])
story_image_0 = simplegui.load_image(
    "http://dax.rip/static/files/rescape/images/splash.png")
story_image_1 = simplegui.load_image (
    "http://dax.rip/static/files/rescape/images/story-1.png")
story_image_2 = simplegui.load_image (
    "http://dax.rip/static/files/rescape/images/story-2.png")
story_image_3 = simplegui.load_image (
    "http://dax.rip/static/files/rescape/images/story-3.png")
story_image_4 = simplegui.load_image (
    "http://dax.rip/static/files/rescape/images/story-4.png")
story_image_5 = simplegui.load_image (
    "http://dax.rip/static/files/rescape/images/story-5.png")
...
nebula_0 = simplegui.load_image(
    "http://dax.rip/static/files/rescape/images/nebula-0.jpg")
nebula_1 = simplegui.load_image(
    "http://dax.rip/static/files/rescape/images/nebula-1.jpg")
nebula_2 = simplegui.load_image(
    "http://dax.rip/static/files/rescape/images/nebula-2.jpg")
nebula_3 = simplegui.load_image(
    "http://dax.rip/static/files/rescape/images/nebula-3.jpg")
nebula_4 = simplegui.load_image(
    "http://dax.rip/static/files/rescape/images/nebula-4.jpg")
nebula_5 = simplegui.load_image(
    "http://dax.rip/static/files/rescape/images/nebula-5.jpg")
nebula_6 = simplegui.load_image(
    "http://dax.rip/static/files/rescape/images/nebula-6.jpg")
nebula_7 = simplegui.load_image(
    "http://dax.rip/static/files/rescape/images/nebula-7.jpg")
nebula_8 = simplegui.load_image(
    "http://dax.rip/static/files/rescape/images/nebula-8.jpg")
nebula_9 = simplegui.load_image(
    "http://dax.rip/static/files/rescape/images/nebula-9.jpg")
...
score_sound = simplegui.load_sound(
    "http://dax.rip/static/files/rescape/sounds/score-alt.mp3")
score_sound.set_volume(0.6)

die_sound = simplegui.load_sound(
    "http://dax.rip/static/files/rescape/sounds/die.mp3")
die_sound.set_volume(1)

game_over_sound = simplegui.load_sound(
    "http://dax.rip/static/files/rescape/sounds/game-over.mp3")
game_over_sound.set_volume(1)

transmission_1 = simplegui.load_sound(
    "http://dax.rip/static/files/rescape/sounds/transmission-1.mp3")
transmission_1.set_volume(1)

transmission_2 = simplegui.load_sound(
    "http://dax.rip/static/files/rescape/sounds/transmission-2.mp3")
